<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="flex flex-row justify-center sm:justify-end gap-2 sm:gap-4">
        ...
        <form method="post" action="{{ route('admin.job-posts.update', $jobPost) }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-select-input id="position_type" name="position_type" :options="$positionTypes"
                    placeholder="{{ __('Select a Position Type') }}" :selected="old('position_type', $jobPost->position_type)" class="mt-1 block w-full" />
            ...
            <div class="mt-6">
                ...
                <x-text-input id="salary" name="salary" type="text" :value="old('salary', $jobPost->salary)"
                    placeholder="{{ __('99999.99') }}" class="mt-1 block w-full" />
